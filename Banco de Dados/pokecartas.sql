...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16/12/2024 às 03:28
...
--
-- Despejando dados para a tabela `album_carta`
--
...
--
ALTER TABLE `album`
  MODIFY `id_album` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `album_carta`
--
ALTER TABLE `album_carta`
  MODIFY `id_album_carta` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
